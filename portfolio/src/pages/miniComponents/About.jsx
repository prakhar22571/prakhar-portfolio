  ...
  return (
    <div className="w-full flex flex-col overflow-x-hidden">
      ...
      <div className="text-center">
        <p className="uppercase text-xl text-slate-400">My Introduction</p>
      </div>
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          ...
          >
            <p>
              I&apos;m Prakhar Rai, a Software Engineer at UKG building
              large-scale developer platforms, CI/CD infrastructure, and
              internal AI tooling. I hold a B.Tech in Computer Science &
              Engineering from the Indian Institute of Information Technology,
              Bhagalpur (2021 - 2025), and I work at the intersection of backend
            ...
            <p className="tracking-[1px] text-xl">
              ...
              engineering problems — from an offline AI code review assistant to
              a Bluetooth Mesh-based offline UPI payment system for
